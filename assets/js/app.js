(() => {
  ...
  function initSliders() {
    if (document.querySelector(".merch-swiper")) new swiper_core_Swiper(".merch-swiper", {
      ...
      navigation: {
        prevEl: ".merch-button-prev",
        nextEl: ".merch-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 2.5,
    ...
    if (document.querySelector(".retreats-swiper")) new swiper_core_Swiper(".retreats-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1.2,
      spaceBetween: 15,
      speed: 800,
      ...
      navigation: {
        prevEl: ".retreats-button-prev",
        nextEl: ".retreats-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 3,
    ...
    if (document.querySelector(".retreat-swiper")) new swiper_core_Swiper(".retreat-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1,
      spaceBetween: 20,
      speed: 800,
      ...
      loop: true,
      pagination: {
        el: ".retreat-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".retreat-button-prev",
        nextEl: ".retreat-button-next"
      },
      breakpoints: {
        1024: {
          slidesPerView: 1.5
    ...
    if (document.querySelector(".eyes-swiper")) new swiper_core_Swiper(".eyes-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 2,
      spaceBetween: 8,
      speed: 800,
    ...
    if (document.querySelector(".reader-swiper")) new swiper_core_Swiper(".reader-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1.3,
      spaceBetween: 20,
      speed: 800,
      ...
      loop: true,
      pagination: {
        el: ".reader-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".reader-button-prev",
        nextEl: ".reader-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 2.3
    ...
    if (document.querySelector(".books-swiper")) new swiper_core_Swiper(".books-swiper", {
      modules: [Scrollbar],
      slidesPerView: 4,
      spaceBetween: 20,
      speed: 800,
    ...
    if (document.querySelector(".oapo-swiper")) {
      const mainSwiper = new swiper_core_Swiper(".oapo-swiper", {
        modules: [Navigation],
        slidesPerView: 2,
        spaceBetween: 15,
        speed: 800,
        loop: true,
        navigation: {
          prevEl: ".oapo-button-prev",
          nextEl: ".oapo-button-next"
        },
        breakpoints: {
          768: {
            spaceBetween: 70
      ...
      function makeFadeSwiper(selector) {
        const sw = new swiper_core_Swiper(selector, {
          modules: [Navigation],
          slidesPerView: 1,
          spaceBetween: 0,
          speed: 800,
        ...
        sw.on('setTranslate', function () {
          sw.slides.forEach(function (slideEl) {
            var offset = slideEl.swiperSlideOffset || 0;
            var progress = slideEl.progress !== undefined ? slideEl.progress : 0;
            slideEl.style.transform = 'translate3d(' + (-offset) + 'px, 0px, 0px)';
            slideEl.style.opacity = Math.max(1 - Math.abs(progress), 0);
          });
        });
        sw.on('setTransition', function (swiper, duration) {
          sw.slides.forEach(function (slideEl) {
            slideEl.style.transitionDuration = duration + 'ms';
            slideEl.style.transitionTimingFunction = 'ease-in-out';
          });
        });
        return sw;
      }

      const imageSwiper = makeFadeSwiper(".oapo-swiper2");
      const contentSwiper = makeFadeSwiper(".oapo-swiper3");

      // loop: false → slides.length = точна кількість книг без клонів
      const totalBooks = imageSwiper.slides.length;

      function syncSide(speed) {
        var target = (mainSwiper.realIndex + 2) % totalBooks;
        imageSwiper.slideTo(target, speed);
        contentSwiper.slideTo(target, speed);
      }

      mainSwiper.on('slideChange', function () { syncSide(800); });

      // Початкова синхронізація: mainSwiper на 0 → показуємо слайд 2
      syncSide(0);
    }

    if (document.querySelector(".review-swiper")) new swiper_core_Swiper(".review-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1,
      spaceBetween: 82,
      speed: 800,
    ...
    if (document.querySelector(".subscribe-swiper")) new swiper_core_Swiper(".subscribe-swiper", {
      ...
      loop: true,
      pagination: {
        el: ".subscribe-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".subscribe-button-prev",
        nextEl: ".subscribe-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 3
    ...
    if (document.querySelector(".courses-swiper")) new swiper_core_Swiper(".courses-swiper", {
      ...
      loop: true,
      pagination: {
        el: ".courses-slider .slider-pagination",
        clickable: true
      },
      scrollbar: {
        el: ".courses-slider .slider-scrollbar"
      },
      navigation: {
        prevEl: ".courses-slider .slider-button-prev",
        nextEl: ".courses-slider .slider-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 2
    ...
    if (document.querySelector(".all-swiper")) new swiper_core_Swiper(".all-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1,
      spaceBetween: 20,
      speed: 800,
      pagination: {
        el: ".all-slider .slider-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".all-slider .slider-button-prev",
        nextEl: ".all-slider .slider-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 2.1
    ...
    if (document.querySelector(".article-swiper")) new swiper_core_Swiper(".article-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1,
      spaceBetween: 20,
      speed: 800,
      loop: true,
      pagination: {
        el: ".article-content__slider .slider-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".article-content__slider .slider-button-prev",
        nextEl: ".article-content__slider .slider-button-next"
      },
      on: {}
    });
    if (document.querySelector(".other-swiper")) new swiper_core_Swiper(".other-swiper", {
      modules: [Navigation, Pagination],
      slidesPerView: 1,
      spaceBetween: 20,
      speed: 800,
      loop: true,
      pagination: {
        el: ".article-other .slider-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".article-other .slider-button-prev",
        nextEl: ".article-other .slider-button-next"
      },
      breakpoints: {
        768: {
          slidesPerView: 2
  ...
  class Accordion {
    constructor(selector) {
      ...
      this.multiple = this.accordion.getAttribute("data-accordion") === "multiple";
    ...
    init() {
      this.items.forEach((item => {
        ...
        _slideUp(item.querySelector(".accordion__body"));
      }));
    }
    toggleItem(item) {
      const isActive = item.classList.contains("active");
      _slideToggle(item.querySelector(".accordion__body"));
      if (!this.multiple) this.closeAll();
      if (!isActive) this.openItem(item);
    }
    openItem(item) {
      item.classList.add("active");
      _slideDown(item.querySelector(".accordion__body"));
    }
    closeAll() {
      this.items.forEach((item => {
  ...
  document.addEventListener("DOMContentLoaded", (function () {
    ...
    document.addEventListener("click", (function (event) {
      const isClickInsideMenu = [...menuItems].some((item => item.contains(event.target)));
      if (!isClickInsideMenu) menuItems.forEach((item => {
        item.classList.remove("active");
        const subMenu = item.querySelector(".sub-menu");
    ...
    document.addEventListener("DOMContentLoaded", (function () {
      ...
      function initializeSwitcher() {
        const currentLang = document.querySelector('.language-option[data-is-current="1"]');
        console.log(currentLang);
        if (currentLang && switcherCircle) if (currentLang.id === "en") {
          switcherCircle.classList.add("active");
          switcher.classList.add("active");
        } else {
          switcherCircle.classList.remove("active");
      ...
      languageOptions.forEach((option => {
        option.addEventListener("click", (function () {
          ...
          if (!isCurrent && url) window.location.href = url;
        }));
      }));
      if (switcher) switcher.addEventListener("click", (function () {
        const currentLang = document.querySelector('.language-option[data-is-current="1"]');
        const targetLang = currentLang && currentLang.id === "ru" ? document.querySelector("#en") : document.querySelector("#ru");
        if (targetLang) {
          const url = targetLang.getAttribute("data-url");
      ...
      languageOptions.forEach((option => {
        option.addEventListener("mouseenter", (function () {
          if (this.getAttribute("data-is-current") !== "1") this.style.opacity = "0.7";
        }));
    ...
    function setActiveLanguage(lang) {
      ...
      if (lang === "en") document.querySelector(".switcher").classList.add("active");
    }
    function toggleLanguage() {
      const ruActive = document.getElementById("ru").classList.contains("active");
      setActiveLanguage(ruActive ? "en" : "ru");
    }
    document.getElementById("ru").addEventListener("click", (() => setActiveLanguage("ru")));
    document.getElementById("en").addEventListener("click", (() => setActiveLanguage("en")));
